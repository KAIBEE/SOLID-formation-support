...
public class DefaultNodeFactory implements NodeFactory {
    ...
    public Node leaf(CommandFactory cmdFactory) {
        return new Node(Objects.requireNonNull(cmdFactory), Collections.emptyList(), PersonPredicate.ALWAYS);
    }
    ...
    public Node middleNode(PersonPredicate guard, Node... nodes) {
        return new Node(null, List.of(nodes), guard);
    }
    ...
    public Node root(Node... nodes) {
        return new Node(null, List.of(nodes), PersonPredicate.ALWAYS);
    }
}
